...
tCircular_List * create_list(tCircular_List * list){
    list->head = NULL;
    list->total_nodes = 0;
...
int is_empty(tCircular_List * list){
    if(list->head == NULL){
        return 1;
    }
    else{
...
int get_list_size(tCircular_List * list){
    return list->total_nodes;
}

int get_value_at_position(tCircular_List * list, int index){
    int i = 1;
...
int modify_value_at_position(tCircular_List * list, int new_value, int index){
    int old_value; 
    int i = 1;
    tNode * node_get_position = list->head;
...
int insert_at_position(tCircular_List * list, int data_value, int index){
    tNode * new_node;
    tNode * node_get_position = list->head;
    int i = 1;
...
int remove_at_position(tCircular_List * list, int index){
    int i = 1;
...
void print_list(tCircular_List * list){
    int i = 1;
...
void free_list(tCircular_List * list){
